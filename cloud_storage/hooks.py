...
app_title = "App that stores data on Google Cloud"
app_publisher = "ERP data"
app_description = "App that stores data on Google Cloud"
...
# 		"title": "App that stores data on Google Cloud",
# 		"route": "/cloud_storage",
